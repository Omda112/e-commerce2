...
import { useSmoothTransform } from "../UseSmooth/UseSmooth";
...
export function Lights() {
  return (
    <>
      <spotLight color="red" position={[-10, -10, -10]} intensity={0.2} />
      <spotLight color="red" position={[-10, 0, 15]} intensity={0.8} />
...
export function Material() {
  return <meshPhongMaterial color="black" specular="#61dafb" shininess={10} />;
}
